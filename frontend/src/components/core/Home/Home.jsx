          ...
          <div className="feed">
            {timeline?.map(user => (
              <>
                ...
                />
                <Stats skills={[user.skill_1, user.skills_2, user.skills_3, user.skills_4]} skillsProf={[user.skill_1_prof, user.skill_2_prof, user.skill_3_prof, user.skill_4_prof]} />
              </>
            ))}
          </div>
        )}
